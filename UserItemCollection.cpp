/*  filename: UserItemCollection.cpp    2008/12/26  */
/*************************************************************************
...
UserItemCollection::UserItemCollection(void)
{
        local = new UserItem;
//         m_collection.insert(local->MacAddress(), local);
}

UserItemCollection::~UserItemCollection(void)
{
        delete local;
//         for (QHash<QString, UserItem*>::iterator i = m_collection.begin(); i != m_collection.end(); i++)
//         {
//                 delete i.value();
//         }
