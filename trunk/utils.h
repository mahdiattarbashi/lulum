...
namespace IPM
{
        ...
        QString GetMacAddrString();

        QString GetFormatedFileSize(quint64 bytes);

        QString GetFormatedTransSpeed(quint64 bytes);

        QStringList ParseFileInfoString(const QString &key);
