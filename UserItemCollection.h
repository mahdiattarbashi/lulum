/*  filename: UserItemCollection.h    2008/12/26  */
/*************************************************************************
...
#ifndef __UserItemCollection_h__
#define __UserItemCollection_h__
...
{
public:
	UserItemCollection(void);
	~UserItemCollection(void);
        QHash<QString, UserItem*>* Collection() { return &m_collection; }
        UserItem* local;
public:
private:
        QHash<QString, UserItem*> m_collection;
};

#endif // __UserItemCollection_h__
